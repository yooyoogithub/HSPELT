'user strict'
            ...
            function grammar2_start(){
                ...
                button.innerHTML = `<input type="button" id="bodybutton" onclick="grammar3_start()" value="Grammar 2 건너뛰기">`;
            ...
            function grammar3_start(){
                ...
                button.innerHTML = `<input type="button" id="bodybutton" onclick="grammar3_skip()" value="Grammar 3 건너뛰기">`;
            ...
            function pv0_click(useranswer,proba,correctanswera,useranswera){
                ...
                if(pvanswer === useranswer){
                    correct ++;
                    answers = answers + `<span style="color:blue">${qnum+1}번.문제[${proba}]</span>-대답(${useranswer}:${useranswera})-정답(${pvanswer}:${correctanswera})/`; 
                }else{
                    answers = answers + `<span style="color:red">${qnum+1}번.문제[${proba}]</span>-대답(${useranswer}:${useranswera})-정답(${pvanswer}:${correctanswera})/`; 
                }
            ...
            function printoutresult(){
                ...
                */
                ...
                document.getElementById('result_upper').innerHTML = buttonprint;

                //base 부분 초기화
                document.getElementById('resulthtml_base').innerHTML = 
                `<br><br><br><br><br>
                ...
                if(total_result.length > 1){
                    ...
                    if(total_result[i][0] === "대문자순서"){
                        ...
                        if((tscore/5) > 79){
                            ...
                            rtext = "Alphabet Phonics 교재를 진행해야 합니다.";
                        }

                        reportform = reportform +
                        `<div id = 'alphabet_display'>
                        <div id='alphabet_result'>
                        ${numbering}. Alphbet Test Result <span style='color:red'><ins>(추천 : ${rtext})</ins></span><br>
                            <div id='nextlinealpha1'>
                                Capital Letters ( Score <span style='color:blue'> : ${total_result[i][1]} 점 </span> )
                            </div>
                            <div style='color:black;margin-left:50px'>
                                Student's Response : <span style='color:blue'>${total_result[i][2]}</span>
                            </div>
                            <hr>
                            
                            <div id='nextlinealpha2'>
                                Small Letters ( Score <span style='color:blue'> : ${total_result[i+1][1]} 점 </span> )
                            </div>
                            <div style='color:black;margin-left:50px'>
                                Student's Response : <span style='color:blue'>${total_result[i+1][2]}</span>
                            </div>
                            <hr>

                            <div id='nextlinealpha3'>
                                Matching Capital & Smll letters ( Score <span style='color:blue'> : ${total_result[i+2][1]} 점 </span> )
                            </div>
                            <div style='color:black;margin-left:50px'>
                                Student's Response : <span style='color:blue'>${total_result[i+2][2]}</span>
                            </div>
                            <hr>

                            <div id='nextlinealpha4'>
                                Alphabet Names( Score <span style='color:blue'> : ${total_result[i+3][1]} 점 </span> )
                            </div>
                            <div style='color:black;margin-left:50px'>
                                Student's Response : <span style='color:blue'>${total_result[i+3][2]}</span>
                            </div>
                            <hr>

                            <div id='nextlinealpha5'>
                                Alphabet Sounds ( Score <span style='color:blue'> : ${total_result[i+4][1]} 점 </span> )
                            </div>
                            <div style='color:black;margin-left:50px'>
                                Student's Response : <span style='color:blue'>${total_result[i+4][2]}</span>
                            </div>
                            <hr>
                        ...
                        if(total_result[i][2] > 79){
                            good.push(['대문자']);
                        }else if(total_result[i][2] > 29){
                            middle.push(['대문자']);
                        }else{
                            poor.push(['대문자']);
                        }

                        if(total_result[i+1][2] > 79){
                            good.push(['소문자']);
                        }else if(total_result[i+1][2] > 29){
                            middle.push(['소문자']);
                        }else{
                            poor.push(['소문자']);
                        }

                        if(total_result[i+2][2] > 79){
                            good.push(['대소문자 매칭']);
                        }else if(total_result[i+2][2] > 29){
                            middle.push(['대소문자 매칭']);
                        }else{
                            poor.push(['대문자']);
                        }

                        if(total_result[i+3][2] > 79){
                            good.push(['알파벳 이름']);
                        }else if(total_result[i+3][2] > 29){
                            middle.push(['알파벳 이름']);
                        }else{
                            poor.push(['알파벳 이름']);
                        }

                        if(total_result[i+4][2] > 79){
                            good.push(['알파벳 소리']);
                        }else if(total_result[i+4][2] > 29){
                            middle.push(['알파벳 소리']);
                        }else{
                            poor.push(['알파벳 소리']);
                        }
                        ...
                        if(good.length > 0){
                            if(middle.length > 0){
                                if(poor.length > 0){
                                    //good, middle, poor 영역이 모두 있을때
                                    commentlist = `위 학생은 ${good} 영역에 강점을 가지고 있으며, ${middle} 영역을 조금 채워줄 필요가 있으며, ${poor} 영역에 대한 학습이 요구됩니다.`;
                                }else{
                                    //good, middle 영역이 있고, poor 영역이 없을때
                                    commentlist = `위 학생은 ${good} 영역에 강점을 가지고 있으며, ${middle} 영역을 조금 채워줄 필요가 있습니다.`;
                                }
                            }else{
                                if(poor.length > 0){
                                    //good, poor 영역이 있고, middle 영역이 없을때
                                    commentlist = `위 학생은 ${good} 영역에 강점을 가지고 있으며, ${poor} 영역에 대한 학습이 요구됩니다.`;
                                }else{
                                    //good 영역이 있고, middle, poor 영역이 없을때
                                    commentlist = `위 학생은 알파벳의 모양과 소리를 잘 알고 있으며, 기본적인 단자음, 단모음에 대한 이해력이 뛰어난 학생입니다. `;
                                }
                            }
                        }else{
                            if(middle.length > 0){
                                if(poor.length > 0){
                                    //middle, poor 영역이 있고, good 영역이 없을때
                                    commentlist = `위 학생은 ${middle} 영역을 조금 채워줄 필요가 있으며, ${poor} 영역에 대한 학습이 요구됩니다.`;
                                }else{
                                    //middle 영역이 있고, good, poor 영역이 없을때
                                    commentlist = `위 학생은 ${middle} 영역을 조금 채워줄 필요가 있습니다.`;
                                }
                            }else{
                                if(poor.length > 0){
                                    //poor 영역이 있고, good, middle 영역이 없을때
                                    commentlist = `위 학생은 알파벳에 대한 이해도가 낮은 편입니다. Alphabet Phonics 교재를 진행하면서 처음부터 차근차근 알파벳 기본학습 진행할 필요가 있습니다.`;
                                }else{
                                    //good, poor, middle 영역이 없을때 => 이 경우는 있을수 없음
                                }
                            }
                        }

                        document.getElementById('alphabetR').innerHTML = reportform;

                        document.getElementById('comment').innerHTML = commentlist;
                        ...
                        let chart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    ...
                                    backgroundColor: [                      
                                            //[]안에 각각의 색깔을.... []없이 단일색깔....[]안의 갯수가 다르면..같은거 까지는 대칭, 그 다음은 default(?? 회색??) 색깔로 동일하게 적용
                                                    'rgb(187, 255, 0)',
                                                    'rgb(0, 234, 255)',
                                                    'rgb(255, 187, 0)',
                                                    'rgb(103, 131, 255)',
                    ...
                    if(total_result.length > i){
                        ...
                        if(total_result[i][0][0] === 'G'){
                            ...
                            let compare = grammar_result[1][3];
                            let partscore=0;
                            let parttotalnum=1;
                            let partcorrectnum=0;

                            let grammar_done_count = 0;
                            let grammar_total_average = 0;
                            let grammar_total_score = 0;

                            for(let j=1;j<grammar_result.length;j++){
                                if(grammar_result[j][0] === 1){ //1단계인지 확인
                                    if(compare != grammar_result[j][3]){
                                        partscore = Math.floor((partcorrectnum/parttotalnum)*100);
                                        if(partscore > 79){
                                            g1_good.push(compare);
                                        }else if(partscore > 49){
                                            g1_middle.push(compare);
                                        }else{
                                            g1_poor.push(compare);
                                        }
                                        compare = grammar_result[j][3];
                                        parttotalnum = 1;
                                        partcorrectnum = 0;
                                        partscore=0;
                                    }
                                    if(grammar_result[j][2] === 0){ //틀린문제
                                        parttotalnum++;
                                    }else{ //맞춘문제
                                        partcorrectnum++;
                                        parttotalnum++;
                                    }
                                }else if(grammar_result[j][0] === 2){ //2단계인지 확인
                                    if(compare != grammar_result[j][3]){
                                        partscore = Math.floor((partcorrectnum/parttotalnum)*100);
                                        if(partscore > 79){
                                            g2_good.push(compare);
                                        }else if(partscore > 49){
                                            g2_middle.push(compare);
                                        }else{
                                            g2_poor.push(compare);
                                        }
                                        compare = grammar_result[j][3];
                                        parttotalnum = 1;
                                        partcorrectnum = 0;
                                ...
                                }else if(grammar_result[j][0] === 3){ //2단계인지 확인
                                    if(compare != grammar_result[j][3]){
                                        partscore = Math.floor((partcorrectnum/parttotalnum)*100);
                                        if(partscore > 79){
                                            g3_good.push(compare);
                                        }else if(partscore > 49){
                                            g3_middle.push(compare);
                                        }else{
                                            g3_poor.push(compare);
                                        }
                                        compare = grammar_result[j][3];
                                        parttotalnum = 1;
                                        partcorrectnum = 0;
                            ...
                            //마지막꺼 처리
                            if(grammar_result[grammar_result.length-1][0] === 1){
                                partscore = Math.floor((partcorrectnum/parttotalnum)*100);
                                if(partscore > 79){
                                    g1_good.push(compare);
                                }else if(partscore > 39){
                                    g1_middle.push(compare);
                                }else{
                                    g1_poor.push(compare);
                                }
                            }else if(grammar_result[grammar_result.length-1][0] === 2){
                                partscore = Math.floor((partcorrectnum/parttotalnum)*100);
                                if(partscore > 79){
                                    g2_good.push(compare);
                                }else if(partscore > 39){
                            ...
                            }else if(grammar_result[grammar_result.length-1][0] === 3){
                                partscore = Math.floor((partcorrectnum/parttotalnum)*100);
                                if(partscore > 79){
                                    g3_good.push(compare);
                                }else if(partscore > 39){
                            ...
                            for(;total_result[i][0][0] === 'G';){
                                if(total_result[i][0][8] === '1'){  // Grammar 1 일때
                                    tscore = Number(total_result[i][1]);
                                    if(tscore > 79){
                                    }else{
                                        rtext = rtext + " Grammar 1 ";
                                    }
                                    mentscore = mentscore + `<div id='nextlinegrammar1'> Grammar 1 score [${total_result[i][1]}]</div>
                                    <div class="grammardp">Good Point : ${g1_good}</div>
                                    <div class="grammardp">middle Point : ${g1_middle}</div>
                                    <div class="grammardp">Poor Point : ${g1_poor}</div>
                                    <hr>
                                    `;
                                    grammar_done_count++;
                                    grammar_total_score=grammar_total_score+total_result[i][1];
                                }else if(total_result[i][0][8] === '2'){ //Grammar 2 일때
                                    tscore = Number(total_result[i][1]);
                                    if(tscore > 79){
                                    }else{
                                        rtext = rtext + " Grammar 2 ";                                        
                                    }
                                    mentscore = mentscore + `<div id='nextlinegrammar2'> Grammar 2 score [${total_result[i][1]}]</div>
                                    <div class="grammardp">Good Point : ${g2_good}</div>
                                    <div class="grammardp">middle Point : ${g2_middle}</div>
                                    <div class="grammardp">Poor Point : ${g2_poor}</div>
                                    <hr>
                                    `;
                                    grammar_done_count++;
                                    grammar_total_score=grammar_total_score+total_result[i][1];
                                    ...
                                    if(tscore > 79){
                                        ...
                                        rtext = rtext + " Grammar 3 ";
                                    }
                                    mentscore = mentscore + `<div id='nextlinegrammar3'> Grammar 3 score [${total_result[i][1]}]</div>
                                    <div class="grammardp">Good Point : ${g3_good}</div>
                                    <div class="grammardp">middle Point : ${g3_middle}</div>
                                    <div class="grammardp">Poor Point : ${g3_poor}</div>
                                    <hr>
                                    `;
                                    grammar_done_count++;
                                    grammar_total_score=grammar_total_score+total_result[i][1];
                            ...
                            reportform = reportform +
                                `<br>
                                ${numbering}. Grammar <span style='color:red'><ins>(추천 : ${rtext})</ins></span>
                                <br>
                                ${mentscore}
                                <div id='Gcomment'></div>
                                </div>
                            ...
                            document.getElementById('grammarR').innerHTML = reportform;

                            grammar_total_average = Math.floor((grammar_total_score/grammar_done_count));

                            if(grammar_total_average > 79){
                                commentlist = `위 학생은 ${grammar_done_count} 단계에 걸친 Grammar Test에서 평균 ${grammar_total_average}의 점수를 받아 
                                영어문법부분에 대한 이해력이 매우 높은편 입니다.
                                위의 각 단계의 Middle Point부분과 Poor Point부분의 대한 학습을 진행하여 영문법에 대한 이해도를 더욱 높여주실것을 추천드립니다.<br>
                                <span style="color:blue">[추천교재] Grammar Gateway 1권 또는 중등영문법 학년별 과정(중1-1권, 중2-3권, 중3-6권)</span><br>
                                [참고] 한솔플러스 Advance Class 문법교재 연계표<br>
                                Grammar Gateway 1권 : 명사, 대명사, 인칭대명사, be동사, 일반동사<br>
                                Grammar Gateway 1권 : 형용사, 부사, 현재진행형, 부정대명사, 조동사, 동사활용, 과거형<br>
                                Grammar Gateway 1권 : 비교급, 접속사, 여러가지 문형, to부정사, 동명사, 현재완료, 여러가지 문장, 관계대명사
                                `;
                            }else if(grammar_total_average>49){
                                commentlist = `위 학생은 ${grammar_done_count} 단계에 걸친 Grammar Test에서 평균 ${grammar_total_average}의 점수를 받아 
                                영어문법부분에 대한 이해력력을 높여줄 필요가 있습니다.
                                위의 각 단계의 Middle Point부분과 Poor Point부분의 대한 학습을 진행하여 영문법에 대한 이해도를 더욱 높여주실것을 추천드립니다.<br>
                                <span style="color:blue">[추천교재] Grammar Jump 1권</span><br>
                                [참고] 한솔플러스 intermediate 문법교재 연계표<br>
                                Grammar Jump 1권 - 명사, 관사, 인칭대명사, 지시대명사, be동사, There is<br>
                                Grammar Jump 2권 - 일반동사, 형용사, 수량형용사, 부사, 현재진행형, 비교급<br>
                                Grammar Jump 3권 - 조동사, 미래시제, 과거시제, 의문사, 명령문, 감탄문, 접속사, 전치사<br>
                                Grammar Jump 4권 - 의문사, 기수, 부정대명사, 과거진행형, 문장의 형삭, 부정의문문
                                `;
                            }else{
                                commentlist = `위 학생은 ${grammar_done_count} 단계에 걸친 Grammar Test에서 평균 ${grammar_total_average}의 점수를 받아 
                                영어문법부분에 대한 이해력력이 많이 부족한 것으로 보입니다. Grammar Start 1권 부터 시작하여 영문법에 대해 처음부터 실력을
                                쌓아 나가길 추천합니다.<br>
                                <span style="color:blue">[추천교재] Grammar Start 1권</span><br>
                                [참고] 한솔플러스 Beginner 문법교재 연계표<br>
                                Grammar Start 1권 - 인칭대명사, 명사, 관사, 지시대명사, be동사, 일반동사, be동사의 부정문과 의문문<br>
                                Grammar Start 2권 - 현재진행형, 일반동사, There is 구문, 조동사, 접속사, 전치사, 명령문
                                `;
                            }

                            document.getElementById('Gcomment').innerHTML = commentlist;
                    ...
                    if(total_result.length > i){
                        ...
                        if(total_result[i][0][0] === 'V'){
                            reportform = reportform +
                            `<br>
                            ${numbering}. Voca <span style='color:red'><ins>(추천 : ${voca_choice})</ins></span><br>`;                            
                            for(let checki=0;checki<1;){
                                if(total_result.length > i){
                                    if(total_result[i][0] === 'Voca0'){
                                        reportform = reportform + 
                                        `<div id='nextlinealpha1'>
                                            Voca Basic 점수 ( ${total_result[i][1]} 점 )
                                        </div>
                                        <div style="padding-left:50px">Student Response</div>
                                        <div class="Vanswer">${total_result[i][2]}</div><br>
                                        `;
                                        i++;
                            ...
                            document.getElementById('vocaR').innerHTML = reportform;

                            if(voca_choice === 'Power Voca 1'){
                                commentlist = `위 학생은 영어어휘에 대한 학습이 필요합니다. Power Voca 1 을 시작으로 풍부한 어휘력을 쌓아나갈수 있도록 해 주세요.`;
                            }else if(voca_choice === 'Power Voca 2'){
                                commentlist = `위 학생은 초등 저학년 수준의 어휘실력을 가지고 있습니다. 초등 고학년 어휘 교재인 Power Voca 2를 시작으로 풍부한 어휘력을 쌓아 나갈수 있도록 해 주세요.`;
                            }else if(voca_choice === 'Power Voca 3'){
                                commentlist = `위 학생은 초등 고학년 수준의 어휘실력을 가지고 있습니다. 중등 1학년 어휘 교재인 Power Voca 3를 시작으로 풍부한 어휘력을 쌓아 나갈수 있도록 해 주세요.`;
                            }else if(voca_choice === 'Power Voca 4'){
                                commentlist = `위 학생은 중등 1학년 수준의 어휘실력을 가지고 있습니다. 중등 2학년 어휘 교재인 Power Voca 4를 시작으로 풍부한 어휘력을 쌓아 나갈수 있도록 해 주세요.`;
                            }else if(voca_choice === 'Power Voca 5'){
                                commentlist = `위 학생은 중등 2학년 수준의 어휘실력을 가지고 있습니다. 중등 3학년 어휘 교재인 Power Voca 를 시작으로 풍부한 어휘력을 쌓아 나갈수 있도록 해 주세요.`;
                            }else{
                                commentlist = `위 학생은 중등 3학년 수준의 어휘실력을 가지고 있습니다. 고등 1단계 어휘 교재인 Power Voca 6를 시작으로 풍부한 어휘력을 쌓아 나갈수 있도록 해 주세요.`;
                            }

                            commentlist = commentlist + "다만, 많은 단어들중 일부의 단어들만을 샘플링하여 치른 결과이므로 보다 정확한 판단을 위해서는 더 많은 어휘들을 PBT로 Test해 보시길 권해드립니다.";

                            document.getElementById('Vcomment').innerHTML = commentlist;
                    ...
                    if(total_result.length > i){
                        ...
                        if(total_result[i][0][0] === 'A'){
                            ...
                            <div id = 'aio_display'>
                                <div id='aio_result'>
                                ${numbering}. 중등 AIO <span style='color:red'><ins>(추천 : ${aio_choice})</ins></span><br>
                                </div>
                                <div id='aio_empty_1'>
                                </div>
                                <div id='aio_empty_2'>
                            ...
                            document.getElementById('middleR').innerHTML = reportform;

                            for(let checki=0;checki<1;){
                                if(total_result.length > i){
                                    if(total_result[i][0][4] === '1'){

                                        document.getElementById('aio_empty_1').innerHTML = `
                                        <div id='aio_1_display'>
                                            <div id='aio_1_score'>
                                                <div id='aio_1_title'>
                                                ...
                                                <div id='aio_1_grammar'>

                                                </div>
                                                <div id='aio_1_expression'>

                                                </div>
                                            </div>
                                            <div id='aio_1_chart1'>
                                                <canvas id="aio_1_myChart1" width="300px" height="300px"></canvas>
                                            </div>
                                            <div id='aoi_1_dchart2'>
                                                <canvas id="aio_1_myChart2" width="300px" height="300px"></canvas>
                                            </div>
                                        </div>
                                        <hr>
                                        `;

                                        document.getElementById('aio_1_title').innerHTML =`<div style="background-color:yellow"> AIO 1 (중등 1학년 1학기 수준)</div>`;
                                        document.getElementById('aio_1_voca').innerHTML = `Vocaburary Score : ${total_result[i][1]}`;
                                        document.getElementById('aio_1_grammar').innerHTML = `Grammar Score : ${total_result[i+1][1]}`;
                                        document.getElementById('aio_1_expression').innerHTML = `Expression Sore : ${total_result[i+2][1]}`;
                                        let ctx = document.getElementById('aio_1_myChart1').getContext('2d');
                                        let ctx2 = document.getElementById('aio_1_myChart2').getContext('2d');
                                        ...
                                        let chart = new Chart(ctx, {
                                            ...
                                            // The data for our dataset
                                            data: {
                                                labels: ['Score', 'Voca', 'Grammar', 'Expression'], //x축에 붙는 각 항목에 대한 item
                                                datasets: [{
                                                    label: 'AIO 1', //그래프의 제목
                                                    backgroundColor: [                      
                                                            //[]안에 각각의 색깔을.... []없이 단일색깔....[]안의 갯수가 다르면..같은거 까지는 대칭, 그 다음은 default(?? 회색??) 색깔로 동일하게 적용
                                                    ...
                                                    borderWidth : 1,
                                                    hoverBorderWidth : 10,
                                                    data: [100,total_result[i][1],total_result[i+1][1],total_result[i+2][1]] //labe의 순서에 맞는 대비값
                                                }]
                                            },
                                            options:{
                                                responsive: false,
                                        ...
                                        let chart2 = new Chart(ctx2, {
                                            // The type of chart we want to create
                                            type: 'bar', //line, bar, raida, doughnut, pie, polarArea, bubble, scatter, area, mixed
                                            // The data for our dataset
                                            data: {
                                                labels: ['Score', 'Voca', 'Grammar', 'Expression'], //x축에 붙는 각 항목에 대한 item
                                                datasets: [{
                                        ...
                                        document.getElementById('aio_empty_2').innerHTML = `
                                        <div id='aio_2_display'>
                                            <div id='aio_2_score'>
                                                <div id='aio_2_title'>
                                                ...
                                                <div id='aio_2_grammar'>

                                                </div>
                                                <div id='aio_2_expression'>

                                                </div>
                                            </div>
                                            <div id='aio_2_chart1'>
                                                <canvas id="aio_2_myChart1" width="300px" height="300px"></canvas>
                                            </div>
                                            <div id='aoi_2_dchart2'>
                                                <canvas id="aio_2_myChart2" width="300px" height="300px"></canvas>
                                            </div>
                                        </div>
                                        <hr>
                                        `;

                                        document.getElementById('aio_2_title').innerHTML =`<div style="background-color:yellow"> AIO 2 (중등 1학년 2학기 수준)</div>`;
                                        document.getElementById('aio_2_voca').innerHTML = `Vocaburary Score : ${total_result[i][1]}`;
                                        document.getElementById('aio_2_grammar').innerHTML = `Grammar Score : ${total_result[i+1][1]}`;
                                        document.getElementById('aio_2_expression').innerHTML = `Expression Sore : ${total_result[i+2][1]}`;
                                        let ctx = document.getElementById('aio_2_myChart1').getContext('2d');
                                        let ctx2 = document.getElementById('aio_2_myChart2').getContext('2d');
                                        ...
                                        document.getElementById('aio_empty_3').innerHTML = `
                                        <div id='aio_3_display'>
                                            <div id='aio_3_score'>
                                                <div id='aio_3_title'>
                                                ...
                                                <div id='aio_3_grammar'>

                                                </div>
                                                <div id='aio_3_expression'>

                                                </div>
                                            </div>
                                            <div id='aio_3_chart1'>
                                                <canvas id="aio_3_myChart1" width="300px" height="300px"></canvas>
                                            </div>
                                            <div id='aoi_3_dchart2'>
                                                <canvas id="aio_3_myChart2" width="300px" height="300px"></canvas>
                                            </div>
                                        </div>
                                        <hr>
                                        `;

                                        document.getElementById('aio_3_title').innerHTML =`<div style="background-color:yellow"> AIO 3 (중등 2학년 1학기 수준)</div>`;
                                        document.getElementById('aio_3_voca').innerHTML = `Vocaburary Score : ${total_result[i][1]}`;
                                        document.getElementById('aio_3_grammar').innerHTML = `Grammar Score : ${total_result[i+1][1]}`;
                                        document.getElementById('aio_3_expression').innerHTML = `Expression Sore : ${total_result[i+2][1]}`;
                                        let ctx = document.getElementById('aio_3_myChart1').getContext('2d');
                                        let ctx2 = document.getElementById('aio_3_myChart2').getContext('2d');
                                        ...
                                        document.getElementById('aio_empty_4').innerHTML = `
                                        <div id='aio_4_display'>
                                            <div id='aio_4_score'>
                                                <div id='aio_4_title'>
                                                ...
                                                <div id='aio_4_grammar'>

                                                </div>
                                                <div id='aio_4_expression'>

                                                </div>
                                            </div>
                                            <div id='aio_4_chart1'>
                                                <canvas id="aio_4_myChart1" width="300px" height="300px"></canvas>
                                            </div>
                                            <div id='aoi_4_dchart2'>
                                                <canvas id="aio_4_myChart2" width="300px" height="300px"></canvas>
                                            </div>
                                        </div>
                                        <hr>
                                        `;

                                        document.getElementById('aio_4_title').innerHTML =`<div style="background-color:yellow"> AIO 4 (중등 2학년 2학기 수준)</div>`;
                                        document.getElementById('aio_4_voca').innerHTML = `Vocaburary Score : ${total_result[i][1]}`;
                                        document.getElementById('aio_4_grammar').innerHTML = `Grammar Score : ${total_result[i+1][1]}`;
                                        document.getElementById('aio_4_expression').innerHTML = `Expression Sore : ${total_result[i+2][1]}`;
                                        let ctx = document.getElementById('aio_4_myChart1').getContext('2d');
                                        let ctx2 = document.getElementById('aio_4_myChart2').getContext('2d');
                                        ...
                                        document.getElementById('aio_empty_5').innerHTML = `
                                        <div id='aio_5_display'>
                                            <div id='aio_5_score'>
                                                <div id='aio_5_title'>
                                                ...
                                                <div id='aio_5_grammar'>

                                                </div>
                                                <div id='aio_5_expression'>

                                                </div>
                                            </div>
                                            <div id='aio_5_chart1'>
                                                <canvas id="aio_5_myChart1" width="300px" height="300px"></canvas>
                                            </div>
                                            <div id='aoi_5_dchart2'>
                                                <canvas id="aio_5_myChart2" width="300px" height="300px"></canvas>
                                            </div>
                                        </div>
                                        <hr>
                                        `;

                                        document.getElementById('aio_5_title').innerHTML =`<div style="background-color:yellow"> AIO 5 (중등 3학년 1학기 수준)</div>`;
                                        document.getElementById('aio_5_voca').innerHTML = `Vocaburary Score : ${total_result[i][1]}`;
                                        document.getElementById('aio_5_grammar').innerHTML = `Grammar Score : ${total_result[i+1][1]}`;
                                        document.getElementById('aio_5_expression').innerHTML = `Expression Sore : ${total_result[i+2][1]}`;
                                        let ctx = document.getElementById('aio_5_myChart1').getContext('2d');
                                        let ctx2 = document.getElementById('aio_5_myChart2').getContext('2d');
                                        ...
                                        document.getElementById('aio_empty_6').innerHTML = `
                                        <div id='aio_6_display'>
                                            <div id='aio_6_score'>
                                                <div id='aio_6_title'>
                                                ...
                                                <div id='aio_6_grammar'>

                                                </div>
                                                <div id='aio_6_expression'>

                                                </div>
                                            </div>
                                            <div id='aio_6_chart1'>
                                                <canvas id="aio_6_myChart1" width="300px" height="300px"></canvas>
                                            </div>
                                            <div id='aoi_6_dchart2'>
                                                <canvas id="aio_6_myChart2" width="300px" height="300px"></canvas>
                                            </div>
                                        </div>
                                        <hr>
                                        `;

                                        document.getElementById('aio_6_title').innerHTML =`<div style="background-color:yellow"> AIO 6 (중등 3학년 2학기 수준)</div>`;
                                        document.getElementById('aio_6_voca').innerHTML = `Vocaburary Score : ${total_result[i][1]}`;
                                        document.getElementById('aio_6_grammar').innerHTML = `Grammar Score : ${total_result[i+1][1]}`;
                                        document.getElementById('aio_6_expression').innerHTML = `Expression Sore : ${total_result[i+2][1]}`;
                                        let ctx = document.getElementById('aio_6_myChart1').getContext('2d');
                                        let ctx2 = document.getElementById('aio_6_myChart2').getContext('2d');
                            ...
                            if(aio_choice === 'AIO 1'){
                                commentlist = `위 학생은 아직 중등 수준의 실력을 갖추지 못하고 있습니다. AIO 1편을 통해 중등 실력을 갖춰 나갈수 있는 토대를 마련하기를 기대합니다.`;
                            }else if(aio_choice === 'AIO 2'){
                                commentlist = `위 학생은 중등 1학년 1학기 수준의 실력을 가지고 있습니다. AIO 2편을 통해 중등 1학년 실력을 갖춰 나갈수 있기를 기대합니다.`;
                            }else if(aio_choice === 'AIO 3'){
                                commentlist = `위 학생은 중등 1학년 2학기 수준의 실력을 가지고 있습니다. AIO 3편을 통해 중등 2학년 실력을 갖춰 나갈수 있기를 기대합니다.`;
                            }else if(aio_choice === 'AIO 4'){
                                commentlist = `위 학생은 중등 2학년 1학기 수준의 실력을 가지고 있습니다. AIO 4편을 통해 중등 2학년 실력을 갖춰 나갈수 있기를 기대합니다.`;
                            }else if(aio_choice === 'AIO 5'){
                                commentlist = `위 학생은 중등 2학년 2학기 수준의 실력을 가지고 있습니다. AIO 5편을 통해 중등 3학년 실력을 갖춰 나갈수 있기를 기대합니다.`;
                            }else{
                                commentlist = `위 학생은 중등 3학년 1학기 수준 이상의 실력을 가지고 있습니다. AIO 6편을 속성으로 진행하고 고등부 수업으로 진행하시기를 추천드립니다.`;
                            }

                            commentlist = commentlist + "다만, 본 수업을 통해서 학습 습득 능력을 평가하여 추천교재를 기준으로 한단계 낮은 교재, 또는 한단계 높은 교재로 진행할수도 있습니다.";

                            document.getElementById('Mcomment').innerHTML = commentlist;
                    ...
                    if(total_result.length > i){
                        ...
                        if(total_result[i][0][0] === "S"){
                            if(phonics_choice == 'NONE'){
                                ...
                                `<div id = 'hsp_display'>
                                    <div id = 'hsp_result'>
                                        ${numbering}. 한솔플러스영어 교재선택을 위한 Test Result<br>
                                        <span style='color:red'><ins>(Story Town 추천 : ${story_choice} / Reading Town 추천 : ${reading_choice})</ins></span><br>
                                        </div>
                                        <div id='hsp_empty_1'>
                                        </div>
                                        <div id='hsp_empty_2'>
                                ...
                                `<div id = 'hsp_display'>
                                    <div id = 'hsp_result'>
                                        ${numbering}. 한솔플러스영어 교재선택을 위한 Test Result<br>
                                        <span style='color:red'><ins>(Phonics 교재 : ${phonics_choice} / Story Town 추천 : ${story_choice} / Reading Town 추천 : ${reading_choice})</ins></span><br>
                                        </div>
                                        <div id='hsp_empty_1'>
                                        </div>
                                        <div id='hsp_empty_2'>
                            ...
                            document.getElementById('hspR').innerHTML = reportform;

                            for(let checki=0;checki<1;){
                                if(total_result.length > i){
                                    if(total_result[i][0][3] === "1"){
                                        document.getElementById('hsp_empty_1').innerHTML = `
                                        <div id='hsp_1_display'>
                                            <div id='hsp_1_score'>
                                                <div id='hsp_1_title'>

                                                </div>
                                                <div id='hsp_1_listening'>

                                                </div>
                                                <div id='hsp_1_phonics'>

                                                </div>
                                                <div id='hsp_1_grammar'>

                                                </div>
                                                <div id='hsp_1_reading'>

                                                </div>
                                            </div>
                                            <div id='hsp_1_chart1'>
                                                <canvas id="hsp_1_myChart1" width="300px" height="300px"></canvas>
                                            </div>
                                            <div id='hsp_1_dchart2'>
                                                <canvas id="hsp_1_myChart2" width="300px" height="300px"></canvas>
                                            </div>
                                        </div>
                                        <hr>
                                        `;

                                        document.getElementById('hsp_1_title').innerHTML =`<div style="background-color:red;color:white">SR 1 Level Test</div>`;
                                        document.getElementById('hsp_1_listening').innerHTML = `Listening Score : ${total_result[i][1]}`;
                                        document.getElementById('hsp_1_phonics').innerHTML = `Phonics Score : ${total_result[i+1][1]}`;
                                        document.getElementById('hsp_1_grammar').innerHTML = `Grammar Sore : ${total_result[i+2][1]}`;
                                        document.getElementById('hsp_1_reading').innerHTML = `Reading Sore : ${total_result[i+3][1]}`;
                                        let ctx = document.getElementById('hsp_1_myChart1').getContext('2d');
                                        let ctx2 = document.getElementById('hsp_1_myChart2').getContext('2d');
                                        ...
                                        let chart = new Chart(ctx, {
                                            ...
                                            // The data for our dataset
                                            data: {
                                                labels: ['Score', 'Listening', 'Phonics', 'Grammar','Reading'], //x축에 붙는 각 항목에 대한 item
                                                datasets: [{
                                                    label: 'SR 1', //그래프의 제목
                                                    backgroundColor: [                      
                                                            //[]안에 각각의 색깔을.... []없이 단일색깔....[]안의 갯수가 다르면..같은거 까지는 대칭, 그 다음은 default(?? 회색??) 색깔로 동일하게 적용
                                                    ...
                                                    borderWidth : 1,
                                                    hoverBorderWidth : 10,
                                                    data: [100,total_result[i][1],total_result[i+1][1],total_result[i+2][1],total_result[i+3][1]] //labe의 순서에 맞는 대비값
                                                }]
                                            },
                                            options:{
                                                responsive: false,
                                        ...
                                        i = i +  5;
                                    }else if(total_result[i][0][3] === "2"){
                                        document.getElementById('hsp_empty_2').innerHTML = `
                                        <div id='hsp_2_display'>
                                            <div id='hsp_2_score'>
                                                <div id='hsp_2_title'>

                                                </div>
                                                <div id='hsp_2_listening'>

                                                </div>
                                                <div id='hsp_2_voca'>

                                                </div>
                                                <div id='hsp_2_grammar'>

                                                </div>
                                                <div id='hsp_2_languageform'>

                                                </div>
                                                <div id='hsp_2_reading'>

                                                </div>
                                            </div>
                                            <div id='hsp_2_chart1'>
                                                <canvas id="hsp_2_myChart1" width="300px" height="300px"></canvas>
                                            </div>
                                            <div id='hsp_2_dchart2'>
                                                <canvas id="hsp_2_myChart2" width="300px" height="300px"></canvas>
                                            </div>
                                        </div>
                                        <hr>
                                        `;

                                        document.getElementById('hsp_2_title').innerHTML =`<div style="background-color:red;color:white">SR 2 Level Test</div>`;
                                        document.getElementById('hsp_2_listening').innerHTML = `Listening Score : ${total_result[i][1]}`;
                                        document.getElementById('hsp_2_voca').innerHTML = `Vocaburary Score : ${total_result[i+1][1]}`;
                                        document.getElementById('hsp_2_grammar').innerHTML = `Grammar Sore : ${total_result[i+2][1]}`;
                                        document.getElementById('hsp_2_languageform').innerHTML = `Language Form Sore : ${total_result[i+3][1]}`;
                                        document.getElementById('hsp_2_reading').innerHTML = `Reading Sore : ${total_result[i+4][1]}`;
                                        let ctx = document.getElementById('hsp_2_myChart1').getContext('2d');
                                        let ctx2 = document.getElementById('hsp_2_myChart2').getContext('2d');
                                        ...
                                        let chart = new Chart(ctx, {
                                            ...
                                            // The data for our dataset
                                            data: {
                                                labels: ['Score', 'Listening', 'Vocaburary', 'Grammar','Language Form','Reading'], //x축에 붙는 각 항목에 대한 item
                                                datasets: [{
                                                    label: 'SR 2', //그래프의 제목
                                                    backgroundColor: [                      
                                                            //[]안에 각각의 색깔을.... []없이 단일색깔....[]안의 갯수가 다르면..같은거 까지는 대칭, 그 다음은 default(?? 회색??) 색깔로 동일하게 적용
                                        ...
                                        i = i +  5;
                                    }else if(total_result[i][0][3] === "3"){
                                        document.getElementById('hsp_empty_3').innerHTML = `
                                        <div id='hsp_3_display'>
                                            <div id='hsp_3_score'>
                                                <div id='hsp_3_title'>

                                                </div>
                                                <div id='hsp_3_listening'>

                                                </div>
                                                <div id='hsp_3_voca'>

                                                </div>
                                                <div id='hsp_3_grammar'>

                                                </div>
                                                <div id='hsp_3_languageform'>

                                                </div>
                                                <div id='hsp_3_reading'>

                                                </div>
                                            </div>
                                            <div id='hsp_3_chart1'>
                                                <canvas id="hsp_3_myChart1" width="300px" height="300px"></canvas>
                                            </div>
                                            <div id='hsp_3_dchart2'>
                                                <canvas id="hsp_3_myChart2" width="300px" height="300px"></canvas>
                                            </div>
                                        </div>
                                        <hr>
                                        `;

                                        document.getElementById('hsp_3_title').innerHTML =`<div style="background-color:red;color:white">SR 3 Level Test</div>`;
                                        document.getElementById('hsp_3_listening').innerHTML = `Listening Score : ${total_result[i][1]}`;
                                        document.getElementById('hsp_3_voca').innerHTML = `Vocaburary Score : ${total_result[i+1][1]}`;
                                        document.getElementById('hsp_3_grammar').innerHTML = `Grammar Sore : ${total_result[i+2][1]}`;
                                        document.getElementById('hsp_3_languageform').innerHTML = `Language Form Sore : ${total_result[i+3][1]}`;
                                        document.getElementById('hsp_3_reading').innerHTML = `Reading Sore : ${total_result[i+4][1]}`;
                                        let ctx = document.getElementById('hsp_3_myChart1').getContext('2d');
                                        let ctx2 = document.getElementById('hsp_3_myChart2').getContext('2d');
                                        ...
                                        i = i +  5;
                                    }else if(total_result[i][0][3] === "4"){
                                        document.getElementById('hsp_empty_4').innerHTML = `
                                        <div id='hsp_4_display'>
                                            <div id='hsp_4_score'>
                                                <div id='hsp_4_title'>

                                                </div>
                                                <div id='hsp_4_listening'>

                                                </div>
                                                <div id='hsp_4_voca'>

                                                </div>
                                                <div id='hsp_4_grammar'>

                                                </div>
                                                <div id='hsp_4_languageform'>

                                                </div>
                                                <div id='hsp_4_reading'>

                                                </div>
                                            </div>
                                            <div id='hsp_4_chart1'>
                                                <canvas id="hsp_4_myChart1" width="300px" height="300px"></canvas>
                                            </div>
                                            <div id='hsp_4_dchart2'>
                                                <canvas id="hsp_4_myChart2" width="300px" height="300px"></canvas>
                                            </div>
                                        </div>
                                        <hr>
                                        `;

                                        document.getElementById('hsp_4_title').innerHTML =`<div style="background-color:red;color:white">SR 4 Level Test</div>`;
                                        document.getElementById('hsp_4_listening').innerHTML = `Listening Score : ${total_result[i][1]}`;
                                        document.getElementById('hsp_4_voca').innerHTML = `Vocaburary Score : ${total_result[i+1][1]}`;
                                        document.getElementById('hsp_4_grammar').innerHTML = `Grammar Sore : ${total_result[i+2][1]}`;
                                        document.getElementById('hsp_4_languageform').innerHTML = `Language Form Sore : ${total_result[i+3][1]}`;
                                        document.getElementById('hsp_4_reading').innerHTML = `Reading Sore : ${total_result[i+4][1]}`;
                                        let ctx = document.getElementById('hsp_4_myChart1').getContext('2d');
                                        let ctx2 = document.getElementById('hsp_4_myChart2').getContext('2d');
            ...
            function realprint(){
                ...
                document.getElementById('result_upper').innerHTML = "";
                window.print();
                document.getElementById('result_upper').innerHTML = `<div><div><input id="resultbutton" type="button" value="print" onclick = "realprint()"></div>`+
                            `<div><input id="resultbutton" type="button" value="다시 돌아가기" onclick="returnfull()"></div></div><br>`;
            }
